...
# `--settings` (see #121) plus `--dangerously-skip-permissions`. Doesn't opt into permissions.nix's
# `hardDenyRules` either, unlike claudio/claudio-thebot; see sandbox-notes.md for what every trade-off costs.
#
