...
//
// You may need to run `chmod +x set-accent-color` first and install the Xcode
// command-line tools.
//
// == How it works ==
//
...
func getSelectedColour() -> String {
  ...
  //
  //    $ set-accent-color blurple
  //    Usage: set-accent-color <red|orange|yellow|green|blue|purple|pink|graphite>
  //
